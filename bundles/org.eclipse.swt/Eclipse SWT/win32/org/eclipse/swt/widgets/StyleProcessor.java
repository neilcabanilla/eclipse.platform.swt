...
public class StyleProcessor {
	...
	public StyleProcessor thenExclude(String styles) {
	    if (currentRule == null) {
	        throw new IllegalStateException("No 'ifOneOf' defined before 'thenExclude'");
	    }
	    currentRule.thenExclude.addAll(Arrays.asList(styles.split(", ")));
	    return this;
	}
	        ...
	        if (matched) {
	            ...
	            for (String s : rule.thenExclude) {
	                try {
	                    ...
	                    System.out.println("Invalid thenExclude: " + s);
	                    e.printStackTrace();
	                }
	            }
	        }
